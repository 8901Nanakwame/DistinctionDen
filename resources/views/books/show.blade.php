<x-layouts::app :title="$book->title">
    <div class="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="md:flex">
                <div class="md:w-1/2 bg-gray-50 flex items-center justify-center p-8">
                    ...
                    @else
                        <div class="w-full h-64 flex items-center justify-center bg-indigo-50 text-indigo-200 rounded-lg">
                ...
                <div class="md:w-1/2 p-8 md:p-12">
                    ...
                    <div class="text-4xl font-black text-teal-600 mb-8">
        ...
        <div class="mt-8 flex justify-between">
            <a href="{{ route('home.books') }}" class="inline-flex items-center text-gray-500 hover:text-teal-600 transition">
