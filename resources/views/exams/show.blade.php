        ...
        <div class="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 overflow-hidden">
            ...
            <div class="p-8">
                <div class="mb-8">
                    ...
                    <p class="text-gray-600 dark:text-gray-400">{{ $exam->description ?? 'No description available.' }}</p>
                </div>
                ...
                <div class="grid grid-cols-3 gap-4 mb-8">
                    ...
                    <div class="p-4 rounded-lg bg-gray-50 dark:bg-gray-900/50">
                        <div class="flex items-center gap-2 mb-2">
                            <flux:icon name="document-text" class="h-5 w-5 text-indigo-600 dark:text-indigo-400" />
                    ...
                    <div class="p-4 rounded-lg bg-gray-50 dark:bg-gray-900/50">
                        <div class="flex items-center gap-2 mb-2">
                            <flux:icon name="users" class="h-5 w-5 text-indigo-600 dark:text-indigo-400" />
